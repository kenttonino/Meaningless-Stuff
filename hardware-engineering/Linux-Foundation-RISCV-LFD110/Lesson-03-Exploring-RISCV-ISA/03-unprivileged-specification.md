...
| _mepc_ (Machine Exception Program Counter) | Stores the program counter value of the instruction that caused an exception of interrupt in machine mode. <br /> It determines where the program should resume execution after handling the exception. Testing. |
